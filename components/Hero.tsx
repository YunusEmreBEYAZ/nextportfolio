...
const Hero = () => {
    return (
        <div className="pb-20 pt-30 text-center">
            <div>
                <Spotlight className="-top-40 -left-10 md:-left-32 md:-top-20 h-screen" fill="white" />
                <Spotlight className="top-10 -left-50 h-[80vh] w-[50vw]" fill="blue" />
                <Spotlight className="top-18 -left-50 h-[80vh] w-[50vw]" fill="white" />
            </div>
